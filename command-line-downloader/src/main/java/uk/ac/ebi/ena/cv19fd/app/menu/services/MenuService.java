...
import uk.ac.ebi.ena.cv19fd.app.menu.enums.AccessionsEntryMethodEnum;
import uk.ac.ebi.ena.cv19fd.app.menu.enums.ActionEnum;
...
public class MenuService {
    ...
    private String eRequestEmailId(DownloadFormatEnum format, String location, Map<String, List<String>> accessionDetailsMap,
        ...
        if (input.equalsIgnoreCase("b")) { // back
            ...
            boolean isValidId = isValidEmailAddress(input);
            if (!isValidId) {
                printValidEmailMessage();
                return showEmailOption();
            } else {
